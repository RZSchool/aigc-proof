//! Public v0.2/v0.3/v0.4 protocol types, strict JSON parsing, and shared validation.
...
pub use model::*;
pub use schema::{
    validate_event_schema, validate_manifest_schema, validate_tsa_profile_schema,
...
pub const WORKSPACE_VERSION: &str = "0.4.0";
...
pub const CREATOR_SIGNATURE_PROFILE: &str = "aigc-proof.creator-signature.cose-ed25519.v2";
