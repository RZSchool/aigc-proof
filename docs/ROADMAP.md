...
The desktop workbench has an independent application version. Workbench 1.1.0 is a local-first
Electron/React client of the 1.0.0 Rust engine, using `ProofHostApi` 2.1.0, fail-closed
native API 2.1.0 discovery, typed opaque references, bounded Main-owned jobs, a supervised
...
separate reviewed phases and are not implied by Workbench 1.1.0.
