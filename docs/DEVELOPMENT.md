...
Workbench startup validates the supervised Utility's native API 1.4.0 / engine 0.3.0 / protocol
0.2.0 and 0.3.0 discovery, execution facts, and limits before proof IPC registration. Main is the authority,
