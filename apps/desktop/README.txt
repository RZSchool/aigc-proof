AIGC-Proof Workbench 0.5.1 Preview
==================================
...
证明包内部 Manifest、资产摘要和事件哈希链是否自洽，并可在证明包完整有效后核对
一个 PNG、JPEG 或 WebP 文件是否与包内声明为 output 的资产字节完全一致。
...
Workbench 0.5.1 使用 ProofHostApi 1.4.0 / native API 1.3.0，并在开放证明操作前核对 engine、
